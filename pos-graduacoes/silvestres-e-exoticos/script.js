      ...
      if (row['Nome SilvestresExó'] && row['Foto SilvestresExó'] && row['Cargo SilvestresExó']) {
        ...
        cardDiv.innerHTML = `
                  ...
                  <div class="teacherCurriculum">
                      <a class="teacherCurriculumLinks" href="${row['Contato SilvestresExó']}" target="_blank" title="Contato"><i class="fa-solid fa-comment"></i></a>
                      <a class="teacherCurriculumLinks" href="${row['Currículo SilvestresExó']}" target="_blank" title="Currículo"><i class="ai ai-lattes"></i>Currículo</a>
                  </div>
              `;
